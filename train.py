...
# --- Helper functions for metrics reporting ---
...
def build_metrics_report(
    ...
    metrics = evaluation_metrics.copy()
...
def get_mlflow_metrics(metrics: dict) -> dict:
    return {
        name: value
...
def add_artifact_info(metrics: dict, run_id: str, tracking_uri: str) -> dict:
...
def main() -> None:
    ...
    evaluation_metrics["confusion_matrix"] = get_confusion_matrix(
        trained_pipeline,
        X_test,
        y_test,
    )
    ...
    mlflow_metrics = get_mlflow_metrics(metrics)
